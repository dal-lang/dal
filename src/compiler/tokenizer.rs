...
impl TokenKind {
    pub fn to_str(&self) -> &str {
        match self {
            ...
            TokenKind::BitShl => "BitShl",
            TokenKind::BitShr => "BitShr",
            TokenKind::BitXor => "BitXor",
            TokenKind::BoolAnd => "BoolAnd",
            TokenKind::BoolOr => "BoolOr",
            TokenKind::CmpEq => "CmpEq",
            TokenKind::CmpGt => "CmpGt",
            TokenKind::CmpGte => "CmpGte",
            TokenKind::CmpLt => "CmpLt",
            TokenKind::CmpLte => "CmpLte",
            TokenKind::CmpNeq => "CmpNeq",
